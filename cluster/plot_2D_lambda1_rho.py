...
def run_experiment_2D_lambda_rho(lambda1_values, rho_values,
    ...
    save_dir       : dossier (cree si besoin) ou sont sauvees les figures,
                     un fichier PNG par methode : "overlap_<methode>.png"
...
def _plot_method_panel(Z1_m, Z2_m, lambda1_values, rho_values, fname,
    ...
    panels = [
        (axes[0], Z1_m, r"Overlap $m_1 = |\hat{\theta}\cdot x_1|$", "(a)"),
        (axes[1], Z2_m, r"Overlap $m_2 = |\hat{\theta}\cdot x_2|$", "(b)"),
    ]
...
if __name__ == "__main__":
    lambda1_values = np.linspace(0, 7.0, 20)   # eviter lambda1=1 (mu_opt diverge)
